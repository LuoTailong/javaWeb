		...
		<script>
            $(function () {
                $.get("${pageContext.request.contextPath}/categoryListServlet",function (data) {
                    console.info(data);
                    var str = "<option value='null'>--请选择分类--</option>";
		...
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/editProductServlet" method="post" >
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="market_price" value="${product.market_price}" id="userAction_save_do_logonName11" class="bg"/>
					</td>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
						商城价格：
					</td>
					<td class="ta_01" bgColor="#ffffff">
						<input type="text" name="shop_price" value="${product.shop_price}" id="userAction_save_do_logonName1" class="bg"/>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<input type="file" name="upload" src=""/>
					</td>
				</tr>
				<tr>
					<td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
